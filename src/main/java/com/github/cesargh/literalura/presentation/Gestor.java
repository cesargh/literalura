...
public class Gestor {
    ...
    enum OpcionMenu {
        ...
        VER_CANTIDAD_DE_LIBROS_POR_IDIOMA(3, "Ver cantidad de libros por idioma"),
        VER_AUTORES(4, "Ver autores"),
        VER_AUTORES_VIVOS(5, "Ver autores vivos"),
        FINALIZAR(9, "Finalizar");
